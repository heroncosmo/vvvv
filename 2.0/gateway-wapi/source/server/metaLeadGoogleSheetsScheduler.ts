...
export const DEFAULT_ANTI_BAN_DELAY_ENABLED = false;
      ...
      try {
        await client.query(`
          CREATE TABLE IF NOT EXISTS google_sheet_lead_integrations (
            ...
            anti_ban_delay_enabled BOOLEAN NOT NULL DEFAULT false,
          ...
          ALTER TABLE google_sheet_lead_integrations
            ADD COLUMN IF NOT EXISTS anti_ban_delay_enabled BOOLEAN NOT NULL DEFAULT false;
          ALTER TABLE google_sheet_lead_integrations
...
function normalizeAntiBanDelayRange(integration: MetaLeadGoogleSheetsIntegrationRecord) {
  const enabled = integration.antiBanDelayEnabled === true;
