...
const router = Router();
const TEST_AGENT_MODEL = "gpt-5.4-mini";
...
Quando o cliente perguntar sobre "catalogo" ou "produtos", responda ao cliente normalmente e solicite a acao estruturada send_media com mediaName "CATALOGO_TESTE".

Exemplo correto:
Cliente: "quero ver o catalogo"
Você: "Claro! Aqui está nosso catálogo completo." + acao estruturada send_media mediaName "CATALOGO_TESTE"`;
    ...
    if (!agent) {
      ...
      await storage.updateAgentConfig(user.id, { model: TEST_AGENT_MODEL });
    ...
    res.json({
      ...
      instructions: [
        ...
        "3. O agente deve pedir a acao estruturada send_media com mediaName CATALOGO_TESTE",
