...
import { clearOutgoingDeduplicationCacheForConversation } from "./messageDeduplicationService";
  ...
  app.post("/api/conversations/:conversationId/clear-history", isAuthenticated, async (req: any, res) => {
    try {
      ...
      clearOutgoingDeduplicationCacheForConversation({
        conversationId,
        userId,
        contactNumber: conversation.contactNumber || conversation.remoteJid || undefined,
      });
