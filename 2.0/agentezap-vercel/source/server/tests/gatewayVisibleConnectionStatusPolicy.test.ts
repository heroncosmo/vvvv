...
assert.equal(
  shouldHoldGatewayConnectionAsRecovering(
    { ...connectedGatewayConnection, isConnected: false, providerStatus: "connected" },
    {
      isConnected: false,
  ...
  true,
  "provider_status connected persistido tambem deve segurar close transitorio como recovering",
);
