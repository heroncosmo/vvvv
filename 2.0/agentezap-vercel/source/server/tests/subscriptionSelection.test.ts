...
test("prefere assinatura ativa com maior cobertura quando existem ativas duplicadas", () => {
  const preferred = pickPreferredSubscriptionCandidate([
    {
      id: "sub-active-newer-expired",
      status: "active",
      createdAt: "2026-06-13T11:00:00.000Z",
      dataFim: "2026-06-10T12:00:00.000Z",
      nextPaymentDate: "2026-06-10T12:00:00.000Z",
    },
    {
      id: "sub-active-covered",
      status: "active",
      createdAt: "2026-06-01T11:00:00.000Z",
      dataFim: "2026-07-10T12:00:00.000Z",
      nextPaymentDate: "2026-07-10T12:00:00.000Z",
    },
  ], new Date("2026-06-13T12:00:00.000Z"));

  assert.equal(preferred?.id, "sub-active-covered");
});
...
test("calcula fallback pela data do comprovante antes da revisao", () => {
  const window = resolveApprovedReceiptActivationWindow(
    {
      id: "sub-approved",
      status: "pending_pix",
      receiptCreatedAt: "2026-05-11T17:20:11.976Z",
      approvedReceiptAt: "2026-06-03T14:26:31.035Z",
      planPeriodicity: "mensal",
    },
    new Date("2026-06-04T12:00:00.000Z"),
  );

  assert.equal(window.dataInicio.toISOString(), "2026-05-11T17:20:11.976Z");
  assert.equal(window.dataFim.toISOString(), "2026-06-10T17:20:11.976Z");
});
...
test("usa maior cobertura quando data_fim e next_payment_date divergem", () => {
  const window = resolveApprovedReceiptActivationWindow(
    {
      id: "sub-approved",
      status: "pending_pix",
      approvedReceiptAt: "2026-06-01T12:00:00.000Z",
      dataInicio: "2026-05-01T12:00:00.000Z",
      dataFim: "2026-06-01T12:00:00.000Z",
      nextPaymentDate: "2026-06-20T12:00:00.000Z",
      planPeriodicity: "mensal",
    },
    new Date("2026-06-02T12:00:00.000Z"),
  );

  assert.equal(window.dataFim.toISOString(), "2026-06-20T12:00:00.000Z");
  assert.equal(window.nextPaymentDate.toISOString(), "2026-06-20T12:00:00.000Z");
});
