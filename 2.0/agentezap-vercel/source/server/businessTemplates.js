...
exports.realEstateTemplate = exports.educationTemplate = exports.healthFitnessTemplate = exports.professionalServicesTemplate = exports.ecommerceTemplate = void 0;
...
// ═══════════════════════════════════════════════════════════
exports.professionalServicesTemplate = {
    // Identity
...
function getTemplateByType(type) {
    var templates = {
        ecommerce: exports.ecommerceTemplate,
        professional: exports.professionalServicesTemplate,
        health: exports.healthFitnessTemplate,
        education: exports.educationTemplate,
        realestate: exports.realEstateTemplate,
    };
...
function applyTemplate(currentConfig, templateType) {
    var template = getTemplateByType(templateType);
    return __assign(__assign(__assign({}, template), currentConfig), { 
        // Garantir que campos essenciais sejam preservados
        userId: currentConfig.userId, companyName: currentConfig.companyName || template.companyName, agentName: currentConfig.agentName || template.agentName, agentRole: currentConfig.agentRole || template.agentRole, templateType: templateType });
}
