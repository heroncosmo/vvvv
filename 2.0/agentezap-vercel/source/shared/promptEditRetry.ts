export const PROMPT_EDIT_REQUEST_MAX_ATTEMPTS = 5;
export const PROMPT_EDIT_REQUEST_RETRY_BASE_DELAY_MS = 3000;
export const PROMPT_EDIT_REQUEST_RETRY_MAX_DELAY_MS = 10000;
