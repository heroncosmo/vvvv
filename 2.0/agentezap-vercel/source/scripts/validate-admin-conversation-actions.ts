...
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || process.env.AGENTEZAP_ADMIN_TEST_PASSWORD;
...
if (!ADMIN_PASSWORD) {
  throw new Error("Defina ADMIN_PASSWORD ou AGENTEZAP_ADMIN_TEST_PASSWORD para rodar este script.");
}
