...
const LOADING_MESSAGES = [
  "Lendo as informacoes do negocio...",
  "Montando as regras de atendimento...",
  "Organizando produtos, horarios e formas de resposta...",
  "Testando uma conversa de exemplo...",
  "Ajustando o tom do agente...",
  "Conferindo se nao falta contexto...",
...
export function PromptGenerator({ onPromptGenerated, onSkip }: PromptGeneratorProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (data.prompt) {
        ...
        throw new Error(data?.message || "Não foi possível criar as instruções");
      }
    } catch (error) {
      ...
      toast({
        ...
        description: "Tente novamente em instantes para criar o agente com o contexto completo do seu negócio.",
        variant: "destructive",
      });
    } finally {
  ...
  if (step === "input") {
    return (
      <div
        ...
        className="flex flex-col items-center justify-start md:justify-center min-h-[50vh] py-4 md:py-8 px-4 animate-in fade-in duration-500"
      >
  ...
  if (step === "generating") {
    return (
      <div
        data-subscription-gate-ignore="true"
        className="flex flex-col items-center justify-center min-h-[60vh] py-16 space-y-8 animate-in fade-in duration-700"
      >
  ...
  if (step === "calibrating") {
    return (
      <div
        data-subscription-gate-ignore="true"
        className="flex flex-col items-center justify-center min-h-[60vh] py-16 space-y-6 animate-in fade-in duration-500"
      >
        <div className="relative">
