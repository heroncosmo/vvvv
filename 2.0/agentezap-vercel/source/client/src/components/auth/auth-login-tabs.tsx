...
const OWNER_DESKTOP_ENTRY_PATH = "/dashboard";
const OWNER_MOBILE_ENTRY_PATH = "/meu-agente-ia";

function getOwnerEntryPath() {
  return typeof window !== "undefined" && window.innerWidth < 768
    ? OWNER_MOBILE_ENTRY_PATH
    : OWNER_DESKTOP_ENTRY_PATH;
}
