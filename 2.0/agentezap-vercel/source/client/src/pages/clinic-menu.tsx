...
import { ClinicAppointmentsPanel } from "@/components/clinic/clinic-appointments-panel";
...
export default function ClinicMenuPage() {
  ...
  const updateConfigMutation = useMutation({
    mutationFn: async (data: Partial<SalonConfig>) => {
      const res = await apiRequest('PUT', '/api/clinic/config', data);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/config"] });
  ...
  const createServiceMutation = useMutation({
    mutationFn: async (data: typeof serviceForm) => {
      const res = await apiRequest('POST', '/api/clinic/services', data);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/services"] });
  ...
  const updateServiceMutation = useMutation({
    mutationFn: async ({ id, data }: { id: string; data: typeof serviceForm }) => {
      const res = await apiRequest('PUT', `/api/clinic/services/${id}`, data);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/services"] });
  ...
  const deleteServiceMutation = useMutation({
    mutationFn: async (id: string) => {
      const res = await apiRequest('DELETE', `/api/clinic/services/${id}`);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/services"] });
  ...
  const createProfessionalMutation = useMutation({
    mutationFn: async (data: typeof professionalForm) => {
      const res = await apiRequest('POST', '/api/clinic/professionals', data);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/professionals"] });
  ...
  const updateProfessionalMutation = useMutation({
    mutationFn: async ({ id, data }: { id: string; data: typeof professionalForm }) => {
      const res = await apiRequest('PUT', `/api/clinic/professionals/${id}`, data);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/professionals"] });
  ...
  const deleteProfessionalMutation = useMutation({
    mutationFn: async (id: string) => {
      const res = await apiRequest('DELETE', `/api/clinic/professionals/${id}`);
      return res.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/clinic/professionals"] });
    ...
    <div className="container mx-auto space-y-6 py-6 pb-28 md:pb-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure sua agenda da clinica, profissionais e orientacoes da IA
          </p>
        </div>
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
          <div className="flex items-center gap-2">
            <Label htmlFor="salon-active">Ativar Clinica</Label>
            <Switch
              id="salon-active"
        ...
        <CardContent className="flex flex-col gap-4 pt-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="font-medium">Agenda integrada ao proprio menu da clinica</span>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="agendamentos" className="space-y-4">
          <ClinicAppointmentsPanel embedded />
        </TabsContent>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Gerencie os servicos e procedimentos da clinica</CardDescription>
              </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Gerencie os profissionais da clinica</CardDescription>
              </div>
        ...
        <TabsContent value="horarios" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure os horarios de atendimento da clinica</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    A clinica sempre consulta a agenda real antes de sugerir um horario.
                  </p>
                </div>
                <Select
      ...
      <Dialog open={isServiceModalOpen} onOpenChange={setIsServiceModalOpen}>
        <DialogContent className="w-[95vw] max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingService ? 'Edite os dados do serviço' : 'Adicione um novo servico ou procedimento a clinica'}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
      ...
      <Dialog open={isProfessionalModalOpen} onOpenChange={setIsProfessionalModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {editingProfessional ? 'Edite os dados do profissional' : 'Adicione um novo profissional a clinica'}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
