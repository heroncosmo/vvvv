...
export default function Agendamento3AgenticPage() {
  ...
  const connectGoogleMutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      await openGoogleCalendarPopup(data.authUrl, "agendamento3-google-calendar");
      queryClient.invalidateQueries({ queryKey: ["/api/agendamento-3/status"] });
  ...
  return (
    <PremiumBlocked
      title="Agendamento 3.0"
      subtitle="Seu periodo de teste acabou"
      description="Assine um plano para usar agenda inteligente com Google Calendar."
