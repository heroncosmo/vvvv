...
import { SalonAppointmentsPanel } from "@/components/salon/salon-appointments-panel";
    ...
    <div className="container mx-auto space-y-6 py-6 pb-28 md:pb-6">
        ...
        <CardContent className="flex flex-col gap-4 pt-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="font-medium">Agenda integrada ao proprio menu do salao</span>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="agendamentos" className="space-y-4">
          <SalonAppointmentsPanel embedded />
        </TabsContent>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    O salao sempre consulta a agenda real antes de sugerir um horario.
                  </p>
                </div>
                <Select
